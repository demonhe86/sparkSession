package me.simon.sparkProject.spark.page;
...
import me.simon.sparkProject.util.NumberUtils;
import me.simon.sparkProject.util.ParamUtils;
import me.simon.sparkProject.util.SparkUtils;
...
public class PageOneStepConvertRateSpark {
    public static void main(String[] args) {
        ...
        // 使用者指定的页面流是3,2,5,8,6
        // 拿到的这个pageSplitPvMap，3->2，2->5，5->8，8->6
        ...
        return sessionid2actionsRDD.flatMapToPair(
                new PairFlatMapFunction<Tuple2<String, Iterable<Row>>, String, Integer>() {
                    ...
                    public Iterable<Tuple2<String, Integer>> call(Tuple2<String, Iterable<Row>> tuple) throws Exception {
                        ...
                        // 这里，拿到的session的访问行为，默认情况下是乱序的
                        // 第一件事情，对session的访问行为数据按照时间进行排序
                        ...
                        Collections.sort(rows, new Comparator<Row>() {
                            ...
                            public int compare(Row o1, Row o2) {
                                ...
                                Date dateTime1 = DateUtils.parseTime(actionTime1);
                                Date dateTime2 = DateUtils.parseTime(actionTime2);
    ...
    private static long getStartPagePv(
        ...
        JavaRDD<Long> startPageRDD = sessionid2actionsRDD.flatMap(new FlatMapFunction<Tuple2<String, Iterable<Row>>, Long>() {
            private static final long serialVersionUID = -7958443301980026988L;
