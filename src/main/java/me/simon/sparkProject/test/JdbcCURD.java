    ...
    private static void insert() {
        ...
        try {
            ...
            conn = DriverManager.getConnection(
                    "jdbc:mysql://114.215.95.17:3306/spark_project?useUnicode=true&characterEncoding=utf8",
                    "root",
                    "86"
            );
            ...
            String sql = "insert into test_user(name,age) values('李四', 100)";
            int rtn = stmt.executeUpdate(sql);
            System.out.println("影响了" + rtn);
        } catch (Exception e) {
            e.printStackTrace();
